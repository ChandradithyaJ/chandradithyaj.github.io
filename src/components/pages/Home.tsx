            ...
            <div className="space-y-6 max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                {/* <Button variant="secondary" size="lg" asChild>
                  <a href="//assets/ChandraJonnalagaddaCV.pdf" target="_blank" rel="noopener noreferrer">
                ...
                <Button variant="secondary" size="lg" asChild>
                  <a href="//assets/ChandraJonnalagaddaResume.pdf" target="_blank" rel="noopener noreferrer">
                    <FileText className="mr-2 h-4 w-4" />
                    Resume
                  </a>
                </Button>
      ...
      <section className="py-4 border-y border-border/40">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 lg:gap-16">
            ...
            <img
              src="/images/Brown-University-Logo.jpg"
            ...
            />
            <img
              src="/images/rbcdsai.jpeg"
              alt="Robert Bosch Center for DS and AI"
              className="h-16 md:h-20 lg:h-24 w-auto max-w-32 md:max-w-40 lg:max-w-48 object-contain opacity-70 hover:opacity-100 transition-opacity grayscale hover:grayscale-0"
            />
            <img
              src="/images/Sigma-Squad-Logo.jpg"
              alt="Sigma Squad"
              className="h-16 md:h-20 lg:h-24 w-auto max-w-32 md:max-w-40 lg:max-w-48 object-contain opacity-70 hover:opacity-100 transition-opacity grayscale hover:grayscale-0"
            />
            <img
              src="/images/Indian-Institute-of-Technology-Tirupati-Logo-1.png"
              alt="IIT Tirupati"
              className="h-16 md:h-20 lg:h-24 w-auto max-w-32 md:max-w-40 lg:max-w-48 object-contain opacity-70 hover:opacity-100 transition-opacity grayscale hover:grayscale-0"
            />
          </div>
